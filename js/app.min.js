...
let slider_about = new Swiper('.sect-port__row', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
...
const goTopButton = document.querySelector('.footer__top');

goTopButton.addEventListener('click', goTop);
window.addEventListener('scroll', trackScroll);

function trackScroll(){
	const offs = window.pageYOffset;
	const coords = document.documentElement.clientHeight;
	// if(offs > coords){
	// 	goTopButton.classList.add('footer__top-show');
	// } else{							
	// 	goTopButton.classList.remove('footer__top-show');

	// }
	// Скрытие кнопки при достижении верха страницы
}
